    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6 mb-3 d-flex flex-column justify-content-between">
                <div>
                    <h3 style="font-style: italic; color: #084e8b; font-weight: 700">Pedoman GCG</h3>
                ...
                <div class="d-flex justify-content-end align-items-right">
                    <a data-bs-toggle="collapse" data-bs-target="#gcg" aria-expanded="false" aria-controls="gcg" class="btn d-flex justify-content-center" style="width: 210px;">
            ...
            <div class="col-md-6 mb-3 d-flex flex-column justify-content-between order-3 order-md-2">
                <div>                
                    <h3 style="font-style: italic; color: #084e8b; font-weight: 700">Board Manual</h3>
            ...
            <div class="col-md-6 mb-3 d-flex flex-column justify-content-between order-2 order-md-2">
                <div> 
                    <h3 style="font-style: italic; color: #084e8b; font-weight: 700">Pedoman COC</h3>
            ...
            <div class="col-md-6 mb-3 d-flex flex-column justify-content-between order-3 order-md-2">
                <div> 
                    <h3 style="font-style: italic; color: #084e8b; font-weight: 700">Pedoman Pengendalian Gratifikasi</h3>
