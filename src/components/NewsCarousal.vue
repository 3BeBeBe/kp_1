    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                    ...
                    <p>PT Pupuk Indonesia Utilitas berhasil meraih penghargaan dalam ajang Indonesian Quality Award (IQA) tahun 2022 yang diselenggarakan oleh Indonesian Quality Award Foundation (IQAF) bersama BUMN Executive Club (BEC) di hotel Fairmont Jakarta pada Senin, 12 Desember 2022.
                    </p>
                    <div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-4">
                ...
                <p>Pupuk Indonesia Utilitas (PI Utilitas), salah satu anak perusahaan Pupuk Indonesia (Persero) berhasil meraih tiga penghargaan TOP Governance, Risk and Compilance (Tata Kelola, Risiko dan Kepatuhan) Awards 2022 yang digelar di Hotel Raffles, Jakarta, Selasa, 6 September 2022.</p>
            </div>
            <div class="col-md-4">
